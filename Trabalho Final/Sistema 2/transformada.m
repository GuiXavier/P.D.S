...
[y, Fs] = audioread('sistema2.wav');  % Carregar o arquivo de áudio
...
title('Sistema 2 - Sinal Original');  % Título mais descritivo
...
saveas(gcf, 'transhilbert2.jpg');  % Salva a figura como 'transhilbert.jpg'
